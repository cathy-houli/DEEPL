...
int Tail_DP(char *chr,unsigned int start,int mode,char* string,int length,struct cigar_t *cigar,int *cigar_num,struct Splice_DP_t *DP,unsigned int *start_pos,int S)//0 to front 1 to back
{
